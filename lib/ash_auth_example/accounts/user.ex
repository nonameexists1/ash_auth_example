defmodule AshAuthExample.Accounts.User do
  ...
  authentication do
    tokens do
      enabled? true
      token_resource AshAuthExample.Accounts.Token
      signing_secret AshAuthExample.Secrets
    end
    ...
    add_ons do
      confirmation :confirm_new_user do
        ...
        sender AshAuthExample.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end
  end
